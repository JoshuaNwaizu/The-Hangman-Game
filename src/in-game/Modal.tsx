...
const Modal = () => {
  ...
  return (
    <div className={""}>
      ...
      <section className="fixed bottom-0 left-0 right-0 top-0 z-[50] flex h-screen items-center justify-center">
        <div className="flex h-svh items-center justify-center">
          <div className="bg-custom-gradient relative flex h-[29.0625rem] w-[20.25rem] shrink-0 flex-col items-center justify-center gap-[4rem] rounded-[3rem] shadow-[inset_0px_-8px_0px_4px_#140E66,inset_0px_6px_0px_8px_#2463FF]">
            ...
            <div className="flex translate-y-10 flex-col items-center justify-center gap-[2rem]">
              <Button
                name="continue"
                className="uppercase"
                onClick={() =>
                  handleCloseModal(dispatch, navigate, isGuessedComplete, lives)
                }
              />
              <Button
                name="new category"
                className="uppercase"
                onClick={() => handleNavigateToPickCategory(dispatch, navigate)}
              />
